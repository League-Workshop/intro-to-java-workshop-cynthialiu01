...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("scaryMaze2.jpg"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		if(mouseColor==-3462197) {
		JOptionPane.showMessageDialog(null,"You won");
		AudioClip noise = JApplet.newAudioClip(getClass().getResource("yahoo.wav"));
		noise.play();
		}
	...
	private void scare() {
		...
		showScaryImage("blobfish.jpg");
	}

	private void showScaryImage(String blobfish) {
		try {
			maze = ImageIO.read(getClass().getResource(blobfish));
		} catch (Exception e) {
			System.err.println("blobfish.jpg");
		}
		repaint();
	}
