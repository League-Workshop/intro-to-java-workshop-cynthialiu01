	...
	public static void main(String[] args) {
		...
		// back to the [place]. Good luck!
		 JOptionPane.showMessageDialog(null, "Piranhas are more " + a + " during the day, so cross the river \n "
				+ "at night. Piranhas are attracted to fresh " + b + " and will most \n likely take "
						+ "a bite out of your " + c +" if you " + d + ". Whatever you do, \n if you have an "
								+ "open wound, try to find another way to get back to the " + e + ".\n Good luck!");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more active during the day, so cross the river at\n" + 
				...
				"		 likely take a bite out of your leg if you run. Whatever\n" + 
				"		 you do, if you have an open wound, try to find another way to get\n" + 
				"		 back to the cabin.\n                                      Good luck!");
